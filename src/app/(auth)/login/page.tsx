  ...
  return (
    <Card className="neo-card border-4">
      <CardHeader className="space-y-1 text-center">
        <CardTitle className="text-3xl font-black tracking-tight">Selamat Datang</CardTitle>
      ...
      <form action={formAction}>
        ...
        <CardFooter className="flex flex-col space-y-4">
          ...
          <div className="text-center text-sm font-medium">
            Belum punya akun?{" "}
            <Link href="/register" className="underline font-bold hover:text-primary transition-colors">
              Daftar
            </Link>
          </div>
        </CardFooter>
